...
<head>
    ...
    <?php if(APP_STAGE == 'Dev'): ?>
        <link id="css_app" rel="stylesheet" media="screen, print" href="<?php echo e(APP_URL); ?>/ui/theme/default/css/app.min.css?v=<?php echo e(_raid()); ?>">
    <?php else: ?>
        <link id="css_app" rel="stylesheet" media="screen, print" href="<?php echo e(APP_URL); ?>/ui/theme/default/css/app.min.css?v=2">
    <?php endif; ?>
        ...
        <aside class="page-sidebar">
            <div class="page-logo">
                <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                    <?php if($config['top_bar_is_dark']): ?>
                        <img src="<?php echo e(APP_URL); ?>/storage/system/<?php echo e($config['logo_inverse']); ?>" alt="<?php echo e($config['CompanyName']); ?>" aria-roledescription="logo">
                    <?php else: ?>
                        <img src="<?php echo e(APP_URL); ?>/storage/system/<?php echo e($config['logo_default']); ?>" alt="<?php echo e($config['CompanyName']); ?>" aria-roledescription="logo">
                    <?php endif; ?>
            ...
            <nav id="js-primary-nav" class="primary-nav" role="navigation">
                ...
                <div class="info-card">
                    <?php if($user->img): ?>
                        <img src="<?php echo e(APP_URL); ?>/<?php echo e($user->img); ?>" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                    <?php else: ?>
                        <img src="<?php echo e(APP_URL); ?>/ui/lib/img/default-user-avatar.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                    <?php endif; ?>
            ...
            <header class="page-header" role="banner">
                ...
                <div class="page-logo">
                    <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                        ...
                        <span class="page-logo-text mr-1"><?php echo e($config['CompanyName']); ?></span>
                        <span class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2"></span>
                        <i class="fal fa-angle-down d-inline-block ml-1 fs-lg color-primary-300"></i>
                    </a>
                </div>
...
<?php /**PATH /Users/razib/Documents/valet/business-suite/ui/theme/default/layouts/admin.blade.php ENDPATH**/ ?>
