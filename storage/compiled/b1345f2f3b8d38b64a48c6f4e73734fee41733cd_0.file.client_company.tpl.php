<?php
/* Smarty version 3.1.36, created on 2020-06-26 06:07:22
  from '/Users/razib/Documents/valet/business-suite/ui/theme/default/client_company.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5ef5c8da4681a8_54005412',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b1345f2f3b8d38b64a48c6f4e73734fee41733cd' => 
    array (
      0 => '/Users/razib/Documents/valet/business-suite/ui/theme/default/client_company.tpl',
      1 => 1593166039,
      2 => 'file',
    ),
  ),
...
function content_5ef5c8da4681a8_54005412 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_20185487795ef5c8da45b4c2_56678850', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_16760637345ef5c8da466ab6_44583263', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_client']->value));
}
/* {block "content"} */
class Block_20185487795ef5c8da45b4c2_56678850 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_20185487795ef5c8da45b4c2_56678850',
  ),
);
            ...
            <div class="position-absolute pos-top pos-bottom w-100">
                <div class="d-flex h-100 flex-column">
                    <div class="px-3 px-sm-4 px-lg-5 py-4 align-items-center text-center">
                        <?php if ($_smarty_tpl->tpl_vars['company']->value->logo_path) {?>
                            <img src="<?php echo APP_URL;?>
/storage/companies/<?php echo $_smarty_tpl->tpl_vars['company']->value->logo_path;?>
" class="img-fluid" alt="<?php echo $_smarty_tpl->tpl_vars['company']->value->company_name;?>
">
                    ...
                    <div class="pr-3">
                        ...
                        <a href="javascript:;" id="customers" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0 li_customers">
                            <div class="svg-icon svg-icon-primary">
                                ...
                                </i><?php echo $_smarty_tpl->tpl_vars['_L']->value['Customers'];?>

                            </div>
                            <div class="fw-400 fs-xs">(<?php echo Companies::countCustomers($_smarty_tpl->tpl_vars['company']->value->id);?>
)</div>
                        </a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['config']->value['invoicing'] == '1') {?>
                            ...
                            <a href="javascript:void(0)" id="invoices" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0 li_invoices">
                                ...
                                <div class="fw-400 fs-xs">(<?php echo Companies::countInvoices($_smarty_tpl->tpl_vars['company']->value->id);?>
)</div>
                            </a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['config']->value['quotes'] == '1') {?>
                            ...
                            <a href="javascript:void(0)" id="quotes" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0 li_quotes">
                                ...
                                <div class="fw-400 fs-xs">(<?php echo Companies::countQuotes($_smarty_tpl->tpl_vars['company']->value->id);?>
)</div>
                            </a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['config']->value['orders'] == '1') {?>
                            ...
                            <a href="javascript:void(0)" id="orders" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0 li_orders">
                                ...
                                <div class="fw-400 fs-xs">(<?php echo Companies::countOrders($_smarty_tpl->tpl_vars['company']->value->id);?>
)</div>
                            </a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['config']->value['accounting'] == '1') {?>
                            ...
                            <a href="javascript:void(0)" id="transactions" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0 li_transactions">
                                <div class="svg-icon svg-icon-primary">
                                    ...
                                    <?php echo $_smarty_tpl->tpl_vars['_L']->value['Transactions'];?>

                                </div>
                                <div class="fw-400 fs-xs">(<?php echo Companies::countTransactions($_smarty_tpl->tpl_vars['company']->value->id);?>
)</div>
                            </a>
                        ...
                        <input type="hidden" id="cid" value="<?php echo $_smarty_tpl->tpl_vars['company']->value->id;?>
">
 ...
 <?php if ($_smarty_tpl->tpl_vars['company']->value->code) {?>[<?php echo $_smarty_tpl->tpl_vars['company']->value->code;?>
]<?php }?>
                    </h1>
                </div>
                <!-- end inbox title -->
...
/* {/block "content"} */
/* {block "script"} */
class Block_16760637345ef5c8da466ab6_44583263 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_16760637345ef5c8da466ab6_44583263',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
