<?php
/* Smarty version 3.1.36, created on 2021-06-19 16:22:53
  from '/var/www/html/ShreeEng_Test/ui/theme/default/ajax.contact-edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_60cdcc85e200e1_76172670',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e49cf31368ba96ef1faffbfd07c98c70bdf6642e' => 
    array (
      0 => '/var/www/html/ShreeEng_Test/ui/theme/default/ajax.contact-edit.tpl',
      1 => 1616823618,
      2 => 'file',
    ),
  ),
...
function content_60cdcc85e200e1_76172670 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_167147743160cdcc85db7de0_33514449', "head");
?>
...
">
    ...
    <div class="row mt-2">
        <div class="col-md-6">
            <div class="form-group h6"><label for="city"><span class="h6">Company Type</span></label>

                 <select class="form-control" name="company_type" id="company_type">
                <option value="">Select Type</option>
                <option value="OnePerson" <?php if ($_smarty_tpl->tpl_vars['d']->value['company_type'] == ('OnePerson')) {?>selected="selected" <?php }?>  >One Person Company</option>

                 <option  value="LLP" <?php if ($_smarty_tpl->tpl_vars['d']->value['company_type'] == ('LLP')) {?>selected="selected" <?php }?>  >Limited Liability Partnership(LLP)</option>

                 <option  value="PublicLimited" <?php if ($_smarty_tpl->tpl_vars['d']->value['company_type'] == ('PublicLimited')) {?>selected="selected" <?php }?>  >Public Limited Company</option>


                <option value="PrivateLimited" <?php if ($_smarty_tpl->tpl_vars['d']->value['company_type'] == ('PrivateLimited')) {?>selected="selected" <?php }?>  >Private Limited Company</option>

                <option value="Partnership" <?php if ($_smarty_tpl->tpl_vars['d']->value['company_type'] == ('Partnership')) {?>selected="selected" <?php }?>  >Partnership Firm</option>
                <option value="Proprietorship" <?php if ($_smarty_tpl->tpl_vars['d']->value['company_type'] == ('Proprietorship')) {?>selected="selected" <?php }?>  >Proprietorship</option>
                <option value="Section8" <?php if ($_smarty_tpl->tpl_vars['d']->value['company_type'] == ('Section8')) {?>selected="selected" <?php }?>  >Section 8 Company</option>
        ...
        <div class="col-md-6">
            <div class="form-group h6"><label for="state"><span class="h6">TDS Deduction(%)</span></label>
               <input type="number" id="tds_deduction" name="tds_deduction" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['tds_deduction'];?>
">
...
<?php }
/* {block "head"} */
class Block_167147743160cdcc85db7de0_33514449 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'head' => 
  array (
    0 => 'Block_167147743160cdcc85db7de0_33514449',
  ),
);
