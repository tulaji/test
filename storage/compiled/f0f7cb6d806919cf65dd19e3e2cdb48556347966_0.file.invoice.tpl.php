<?php
/* Smarty version 3.1.36, created on 2024-10-05 18:01:36
  from 'C:\xampp\htdocs\CRM_FM\ui\theme\default\invoice.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_670131a8921261_14465723',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f0f7cb6d806919cf65dd19e3e2cdb48556347966' => 
    array (
      0 => 'C:\\xampp\\htdocs\\CRM_FM\\ui\\theme\\default\\invoice.tpl',
      1 => 1728131068,
      2 => 'file',
    ),
  ),
...
function content_670131a8921261_14465723 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_68132067670131a8176532_93189155', "head");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1019176935670131a8307865_61588061', "content");
?>



            <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_92362190670131a8863707_26749409', "script");
$_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "head"} */
class Block_68132067670131a8176532_93189155 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'head' => 
  array (
    0 => 'Block_68132067670131a8176532_93189155',
  ),
);
...
/* {/block "head"} */
/* {block "content"} */
class Block_1019176935670131a8307865_61588061 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_1019176935670131a8307865_61588061',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
if ($_smarty_tpl->tpl_vars['invoice']->value->cn != '') {?> <?php echo $_smarty_tpl->tpl_vars['invoice']->value->cn;?>
                                ...
                                <?php } else { ?>
                                <?php echo $_smarty_tpl->tpl_vars['invoice']->value->id;?>
 <?php }?>
...
"
                                                            ...
                                                            <?php if ($_smarty_tpl->tpl_vars['cs']->value['company'] != '') {?> <?php echo $_smarty_tpl->tpl_vars['cs']->value['company'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                ...
                                                <span class="help-block"><a href="#" id="contact_add">|
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="status" name="status" class="form-control">
                                                    ...
                                                    <option value="Published"
                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->status != 'Draft') {?>selected<?php }?>>
                                                        <?php echo $_smarty_tpl->tpl_vars['_L']->value['Published'];?>
</option>
                                                    <option value="Draft"
                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->status == 'Draft') {?>selected<?php }?>>
                                                        <?php echo $_smarty_tpl->tpl_vars['_L']->value['Draft'];?>
</option>
...
" <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>
                                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value->currency_iso_code == $_smarty_tpl->tpl_vars['key']->value) {?>selected <?php }?> <?php } else { ?>
                                                                <?php if ($_smarty_tpl->tpl_vars['config']->value['home_currency'] == ($_smarty_tpl->tpl_vars['key']->value)) {?>selected <?php }?> <?php }?>
...
" <?php if ($_smarty_tpl->tpl_vars['value']->value['symbol_first']) {?>
                                                                data-symbol-first="yes" <?php } else { ?> data-symbol-first="no" 
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="invoice_title" name="title"
                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->title;?>
" <?php }?>>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='row'>
                                            <div class='col-sm-6'>
                                                <div class="form-group">
                                                    <label for="address"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Billing Address'];?>
</label>
                                            ...
                                            <div class='col-sm-6'>
                                                <div class="form-group">
                                                    <label for="shippingaddress"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Shipping Address'];?>
</label>
                                                    <textarea id="shippingaddress" readonly class="form-control" rows="4"
                                                        name="shippingaddress" style="display:none;"></textarea>
                                                    <div id="shippingaddressdiv"
                                                        style="border: 1px solid #e5e5e5;padding: 10px;background: #f3f3f3;height: 96px;">
                                                    </div>
                                                    <span class="help-block">
                                                        <input type="hidden" id="sameasbilling2" name="sameasbilling"
                                                            value="0" />
                                                        <label class="GFG"> <input type="checkbox" id="sameasbilling"
                                                                name="sameasbilling" value="1"
                                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->sameasbilling == '1') {?> checked <?php }?> />
                                                            Same as Billing Address</label><a href="#" id="shipping_add"
                                                            style="font-size: 14px;color:#6d6767;"> | Or Add New Shipping
                                                            Address</a> </span>
                                                </div>
                                            </div>
                                            ...
                                            <!-- 
<?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>
  <?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_street;?>

   <?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_city;?>

    <?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_state;?>

     <?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_zip;?>

      <?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_country;?>


<?php }?> -->

                                            <input type="hidden" name="m_address_shipping" id="m_address_shipping"
                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_street;?>
" <?php }?>>
                                            <input type="hidden" name="city_shipping" id="city_shipping"
                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_city;?>
" <?php }?>>
                                            <input type="hidden" name="state_shipping" id="state_shipping"
                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_state;?>
" <?php }?>>
                                            <input type="hidden" name="zip_shipping" id="zip_shipping"
                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_zip;?>
" <?php }?>>
                                            <input type="hidden" name="country_shipping" id="country_shipping"
                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_country;?>
" <?php }?>>
                                            ...
                                            <div class='col-sm-6'>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="invoicenum" name="invoicenum"
                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->invoicenum;?>
" 
                                                        <?php } else { ?>
                                                        value="<?php echo $_smarty_tpl->tpl_vars['config']->value['invoice_code_prefix'];?>
" <?php }?>>
                                                </div>
 ...
 #</label>
                                                    ...
                                                    <input type="text" class="form-control" id="cn" name="cn"
                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->cn;?>
" 
                                                        <?php } else { ?>
                                                            value="<?php echo str_pad($_smarty_tpl->tpl_vars['config']->value['invoice_code_current_number'],$_smarty_tpl->tpl_vars['config']->value['number_pad'],'0',STR_PAD_LEFT);?>
"
                                                        <?php }?>>
...
"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="show_quantity_as"
                                                        name="show_quantity_as" <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>
                                                ...
                                                <?php if ($_smarty_tpl->tpl_vars['recurring']->value) {?>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="repeat" id="repeat">
                                                            <option value="daily" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+1 day') {?>
                                                                selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Daily'];?>
</option>
                                                            <option value="week1" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+1 week') {?>
                                                                selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Weekly'];?>
</option>
                                                            <option value="weeks2" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+2 weeks') {?>
                                                                selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Weeks_2'];?>
</option>
                                                            <option value="weeks3" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+3 weeks') {?>
                                                                selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Weeks_3'];?>
</option>
                                                            <option value="weeks4" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+4 weeks') {?>
                                                                selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Weeks_4'];?>
</option>
                                                            <option value="month1" <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?> 
                                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value->r == '+1 month') {?>
                                                                    selected<?php }?> 
                                                                    <?php } else { ?> selected 
                                                                    <?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Month'];?>
</option>
                                                                <option value="months2" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+2 months') {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Months_2'];?>
</option>
                                                                <option value="months3" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+3 months') {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Months_3'];?>
</option>
                                                                <option value="months6" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+6 months') {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Months_6'];?>
</option>
                                                                <option value="year1" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+1 year') {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Year'];?>
</option>
                                                                <option value="years2" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+2 years') {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Years_2'];?>
</option>
                                                                <option value="years3" <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->r == '+3 years') {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Years_3'];?>
</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="place_of_supply" name="place_of_supply" class="form-control">
...
"
                                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value->is_same_state == 1) {?> selected<?php }?>>
                                                                        <?php echo $_smarty_tpl->tpl_vars['config']->value['business_location'];?>
</option>
                                                                    <option value="other" <?php if ($_smarty_tpl->tpl_vars['invoice']->value->is_same_state == 0) {?> selected<?php }?>>
                                                                        Other</option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="idate" name="idate" datepicker
                                                            data-date-format="yyyy-mm-dd" data-auto-close="true" <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>
                                                            value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->date;?>
" <?php } else { ?> value="<?php echo $_smarty_tpl->tpl_vars['idate']->value;?>
" 
                                                            <?php }?>>
                                                    </div>
                                                </div>
...
">
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <select class="form-control" name="duedate" id="duedate">
                                                                <option value="due_on_receipt"
                                                                    <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'])) && ($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'] == 'due_on_receipt')) {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Due On Receipt'];?>
</option>
                                                                <option value="days3"
                                                                    <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'])) && ($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'] == 'days3')) {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['days_3'];?>
</option>
                                                                <option value="days5"
                                                                    <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'])) && ($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'] == 'days5')) {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['days_5'];?>
</option>
                                                                <option value="days7"
                                                                    <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'])) && ($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'] == 'days7')) {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['days_7'];?>
</option>
                                                                <option value="days10"
                                                                    <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'])) && ($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'] == 'days10')) {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['days_10'];?>
</option>
                                                                <option value="days15"
                                                                    <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'])) && ($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'] == 'days15')) {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['days_15'];?>
</option>
                                                                <option value="days30"
                                                                    <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'])) && ($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'] == 'days30')) {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['days_30'];?>
</option>
                                                                <option value="days45"
                                                                    <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'])) && ($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'] == 'days45')) {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['days_45'];?>
</option>
                                                                <option value="days60"
                                                                    <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'])) && ($_smarty_tpl->tpl_vars['config']->value['invoice_default_date'] == 'days60')) {?>
                                                                    selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['days_60'];?>
</option>
                                                            </select>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="duedate">Original for buyer</label>
                                                        <select class="form-control" name="original_for_buyer"
                                                            id="original_for_buyer">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="duedate">Duplicate for Transporter</label>
                                                        <select class="form-control" name="duplicate_for_transporter"
                                                            id="duplicate_for_transporter">
                                                            <option value="YES">YES</option>
                                                            <option value="NO">NO</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="duedate">Third Copy for Supplier</label>
                                                        <select class="form-control" name="third_copy_supplier"
                                                            id="third_copy_supplier">
                                                            <option value="YES">YES</option>
                                                            <option value="NO">NO</option>
                                                        </select>
                                                    </div>
                                            ...
                                            <table class="table table-bordered invoice-table" id="invoice_items">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th rowspan="2">
                                                            <?php if ($_smarty_tpl->tpl_vars['config']->value['show_quantity_as'] == '') {
echo $_smarty_tpl->tpl_vars['_L']->value['Qty'];
} else {
echo $_smarty_tpl->tpl_vars['config']->value['show_quantity_as'];
}?>
                                                        ...
                                                        <th colspan="2">
                                                            ...
                                                            <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>
                                                                ...
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeP" type="radio"
                                                                        name="discount_type" value="p"
                                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value->discount_type == 'p') {?>checked<?php }?>>%
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeF" type="radio"
                                                                        name="discount_type" value="f"
                                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value->discount_type == 'f') {?>checked<?php }?>>Rs
                                                                </label>
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeP" type="radio"
                                                                        name="discount_type" value="p" checked>%
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeF" type="radio"
                                                                        name="discount_type" value="f">Rs
                                                                </label>
...
?>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <textarea class="form-control item_name" name="desc[]"
                                                                        rows="3"><?php echo $_smarty_tpl->tpl_vars['item']->value->description;?>
</textarea>
                                                                    <input type="hidden" name="is_tds[]" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->tds_deduction;?>
">
...
"
                                                                ...
                                                                <td><input type="text" class="form-control qty"
                                                                        value="<?php echo numberFormatUsingCurrency($_smarty_tpl->tpl_vars['item']->value->qty,$_smarty_tpl->tpl_vars['invoice']->value->currency_iso_code);?>
"
                                                                        name="qty[]"></td>
                                                                <td><input type="text" class="form-control item_price" name="amount[]"
                                                                        value="<?php echo numberFormatUsingCurrency($_smarty_tpl->tpl_vars['item']->value->amount,$_smarty_tpl->tpl_vars['invoice']->value->currency_iso_code);?>
">
                                                                <td colspan="2"><input type="text" class="form-control item_discount"
                                                                        name="discount[]"
                                                                        value="<?php echo numberFormatUsingCurrency($_smarty_tpl->tpl_vars['item']->value->discount_rate,$_smarty_tpl->tpl_vars['invoice']->value->currency_iso_code);?>
">
                                                                </td>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control cgst" name="cgst[]" disabled
                                                                        value="">
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control sgst" name="sgst[]" disabled
                                                                        value="">
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control igst" name="igst[]" disabled
                                                                        value="">
                                                                </td>
                                                        ...
                                                        <th colspan="2">
                                                            ...
                                                            <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>
                                                                ...
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeP" type="radio"
                                                                        name="discount_type" value="p"
                                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value->discount_type == 'p') {?>checked<?php }?>> <span
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Percentage'];?>
">%</span>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeF" type="radio"
                                                                        name="discount_type" value="f"
                                                                        <?php if ($_smarty_tpl->tpl_vars['invoice']->value->discount_type == 'f') {?>checked<?php }?>> <span
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Fixed Amount'];?>
" id="fixedDiscountText">
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeP" type="radio"
                                                                        name="discount_type" value="p" checked> <span data-toggle="tooltip"
                                                                        data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Percentage'];?>
">%</span>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeF" type="radio"
                                                                        name="discount_type" value="f"> <span data-toggle="tooltip"
                                                                        data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Fixed Amount'];?>
"
                                                                        id="fixedDiscountText">
                                                                        <?php if ((isset($_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['config']->value['home_currency']]))) {?>
                                                                            <?php echo $_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['config']->value['home_currency']]['symbol'];?>
...
">
                                                                ...
                                                                <td colspan="2"><input type="text" class="form-control item_discount"
                                                                        name="discount[]"
                                                                        value="<?php echo numberFormatUsingCurrency($_smarty_tpl->tpl_vars['item']->value->discount_amount,$_smarty_tpl->tpl_vars['invoice']->value->currency_iso_code);?>
">
                                                                </td>
...
"
                                                            ...
                                                            <?php if ($_smarty_tpl->tpl_vars['ts']->value['is_default'] == '1') {?>selected

                                                            <?php }?>><?php echo $_smarty_tpl->tpl_vars['ts']->value['name'];?>
</option>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> </select></td>
                                        ...
                                        <button type="button" class="btn btn-primary" id="item-add"><i class="fal fa-search"></i>
                                            <?php echo $_smarty_tpl->tpl_vars['_L']->value['Add Product OR Service'];?>
</button>
 ...
 :</strong></td>
                                        ...
                                        <hr>
                                        <label for="user_title">Bank Account Details</label>
                                        <textarea class="form-control" name="bank_account_details" id="bank_account_details" rows="3"
                                            placeholder="Bank Account Details..."><?php if ($_smarty_tpl->tpl_vars['invoice']->value) {
echo $_smarty_tpl->tpl_vars['invoice']->value->bank_account_details;?>
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['config']->value['InvoiceBank'];?>
 <?php }?></textarea>
                                        <br>
                                        ...
                                        <hr>
                                        <label for="user_title">Declaration</label>
                                        <textarea class="form-control" name="declaration" id="declaration" rows="3"
                                            placeholder="Declaration..."><?php if ($_smarty_tpl->tpl_vars['invoice']->value) {
echo $_smarty_tpl->tpl_vars['invoice']->value->declaration;?>
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['config']->value['invoicedeclaration'];?>
 <?php }?></textarea>
                                        <br>
                                        ...
                                        <hr>
                                        <label for="user_title">Invoice Terms</label>
...
/* {/block "content"} */
/* {block "script"} */
class Block_92362190670131a8863707_26749409 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_92362190670131a8863707_26749409',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
>
                    ...
                    function formatCurrency(amount) {
                        ...
                        return prefix + clx_number_format(amount, 2, getSelectedCurrencyDecimalMark(),
                            getSelectedCurrencyThousandsSeparator()) + suffix;
...
')
                    ...
                    $(document).ready(function() {
                        $('#sameasbilling').attr('disabled', true); // On Load, should it be read only?
                    });
                    ...
                    $(document).ready(function() {
                        ...
                        function spEditor(selector) {
                            ...
                            $(selector).redactor({
                                minHeight: 30,
                                buttons: ['html', '|', 'formatting', '|', 'bold', 'italic', 'link', 'unorderedlist',
                                    'orderedlist'
                                ]
                            });
...
",
         ...
         */
                        ...
                        $('#shipping_add').on('click', function(e) {
                            e.preventDefault();
                            ...
                            if (cid != '') {
                                ...
                                $.fancybox.open({
                                    src: _url + 'contacts/modal_add_shipping/',
                                    type: 'ajax',
                                    opts: {
                                        afterShow: function(instance, current) {
                                            $("#country").select2({
                        ...
                        $('#blank-add').on('click', function() {
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['config']->value['tax_system'] == 'India') {?>
                                ...
                                $invoice_items.find('tbody')
                                    .append(
                                        '<tr>  <td><textarea class="form-control item_name" name="desc[]" rows="3" id="i_' +
                                        rowNum +
                                        '"></textarea> <input type="hidden" name="item_code[]" value=""> </td> <td><input type="text" class="form-control tax_code" value="" name="tax_code[]"></td>' +
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['config']->value['tax_system'] == 'India') {?>
                                    ...
                                    $invoice_items.find('tbody')
                                        .append(
                                            '<tr>  <td><textarea class="form-control item_name" name="desc[]" rows="3" id="i_' +
                                            rowNum + '">' + item_name +
                                            '</textarea> <input type="hidden" name="item_code[]" value="' +
                                            item_code + '"><input type="hidden" name="is_tds[]" value="' + is_tds +
                                            '"> </td> <td><input type="text" class="form-control tax_code" value="" name="tax_code[]"></td>' +
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> </select></td> <td class="ltotal"><input type="text" class="form-control lvtotal" readonly="" value=""></td>  </tr>'
                        ...
                        $modal.on('click', '.address_submit1', function(e) {
                            e.preventDefault();
                            ...
                            if (address != '' && city != '' && state != '' && country != '' && zip != '') {
                                ...
                                $('#m_address_shipping').val(address);
                                $('#city_shipping').val(city);
                                $('#state_shipping').val(state);
                                $('#zip_shipping').val(zip);
                                $('#country_shipping').val(country);

                                var address_full = '<div>' + address + '<br/>' + city + '<br/>' + state + ' ' + zip +
                                    '<br/>' + country + '</div>';

                                var adrs = $("#shippingaddressdiv");
                                adrs.html(address_full);
                        ...
                        $("#add_discount").click(function(e) {
                            ...
                            bootbox.dialog({
                                ...
                                message: '<div class="row">  ' +
                                    ...
                                    '<div class="form-group"> ' +
                                    '<label class="col-md-4 control-label" for="set_discount">' + $(
                                        "#_lan_discount").val() + '</label> ' +
                                    '<div class="col-md-4"> ' +
                                    '<input id="set_discount" name="set_discount" type="text" class="form-control input-md" value="' +
                                    c_discount + '"> ' +
                                    '</div> ' +
                                    '</div> ' +
                                    '<div class="form-group"> ' +
                                    '<label class="col-md-4 control-label" for="set_discount_type">' + $(
                                        "#_lan_discount_type").val() + '</label> ' +
                                    '<div class="col-md-4"> <div class="radio"> <label for="set_discount_type-0"> ' +
                                    '<input type="radio" name="set_discount_type" id="set_discount_type-0" value="p" ' +
                                    p_checked + '> ' +
                                    '' + $("#_lan_percentage").val() + ' (%) </label> ' +
                                    '</div><div class="radio"> <label for="set_discount_type-1"> ' +
                                    '<input type="radio" name="set_discount_type" id="set_discount_type-1" value="f" ' +
                                    f_checked + '> ' + $("#_lan_fixed_amount").val() + ' </label> ' +
                                    '</div> ' +
                                    '</div> </div>' +
                                    '</form> </div>  </div>',
                                buttons: {
                                    success: {
                                        ...
                                        callback: function() {
                                            ...
                                            var discount_type = $("input[name='set_discount_type']:checked")
                                                .val();
...
storage/items/thumb'+ val.image;
                                        ...
                                        b_p =
                                            '<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4"><div class="pos_item text-center" id="pos_item_' +
                                            val.id + '" data-pos-item-name="' + val.name +
                                            '" data-pos-item-price="' + val.sales_price + '" data-id="' + val.id +
                                            '" data-pos-item-number="' + val.item_number + '"><img src="' + image +
                                            '" alt="' + item_name + '" class="img-circle"><hr>' + item_name +
                                            ' <br>' + val.sales_price + '  <hr></div> </div>';
                            ...
                            $block_items.on('click', '.pos_item', function() {
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['config']->value['tax_system'] == 'India') {?>
                                    ...
                                    $invoice_items.find('tbody')
                                        .prepend(
                                            '<tr>  <td><textarea class="form-control item_name" name="desc[]" rows="3" id="i_' +
                                            item_sl + '">' + pos_item_name +
                                            '</textarea> <input type="hidden" name="item_code[]" value="' + pos_item_number +
                                            '"> </td> <td><input type="text" class="form-control tax_code" value="" name="tax_code[]"></td>' +
