...
function content_5f2c5737427022_17263321 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_16253588765f2c57373c9fa1_30603238', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_9720984665f2c5737423eb0_72732404', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "content"} */
class Block_16253588765f2c57373c9fa1_30603238 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_16253588765f2c57373c9fa1_30603238',
  ),
);
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['d']->value['stage'] != 'Pending') {?>
                                        <li class="dropdown-item"><a href="#" id="mark_stage_pending" class="set_status">Pending</a></li>
                                    <?php }?>
                                    <?php if ($_smarty_tpl->tpl_vars['d']->value['stage'] != 'Accepted') {?>
                                        <li class="dropdown-item"><a href="#" id="mark_stage_accepted" class="set_status">Accepted</a></li>
                                    <?php }?>

                                    <?php if ($_smarty_tpl->tpl_vars['d']->value['stage'] != 'Declined') {?>
                                        <li  class="dropdown-item"><a href="#" id="mark_stage_declined" class="set_status">Declined</a></li>
                                    <?php }?>

                                    <?php if ($_smarty_tpl->tpl_vars['d']->value['stage'] != 'On Hold') {?>
                                        <li  class="dropdown-item"><a href="#" id="mark_stage_on_hold" class="set_status">On Hold</a></li>
                                    <?php }?>

                                    <?php if ($_smarty_tpl->tpl_vars['d']->value['stage'] != 'Cancelled') {?>
                                        <li class="dropdown-item"><a href="#" id="mark_stage_cancelled" class="set_status">Cancelled</a></li>
                                    <?php }?>
...
/* {/block "content"} */
/* {block "script"} */
class Block_9720984665f2c5737423eb0_72732404 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_9720984665f2c5737423eb0_72732404',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
