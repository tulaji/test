<?php
/* Smarty version 3.1.36, created on 2021-06-17 10:21:03
  from '/var/www/html/ShreeEng_Test/ui/theme/default/invoice.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_60cad4b7d11565_04955388',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd32afb313b9fc4ff0fe6eeaad5c7649698590e2d' => 
    array (
      0 => '/var/www/html/ShreeEng_Test/ui/theme/default/invoice.tpl',
      1 => 1619286962,
      2 => 'file',
    ),
  ),
...
function content_60cad4b7d11565_04955388 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_201988006760cad4b7b9ae48_92618673', "head");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_74837588360cad4b7ba4949_22144560', "content");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_133969369360cad4b7ca8bf5_86401042', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "head"} */
class Block_201988006760cad4b7b9ae48_92618673 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'head' => 
  array (
    0 => 'Block_201988006760cad4b7b9ae48_92618673',
  ),
);
...
/* {/block "head"} */
/* {block "content"} */
class Block_74837588360cad4b7ba4949_22144560 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_74837588360cad4b7ba4949_22144560',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-sm-6'>
                                            <div class="form-group">
                                                ...
                                                <textarea id="shippingaddress" readonly class="form-control" rows="4" name="shippingaddress" style="display:none;"></textarea>
                                                <div id="shippingaddressdiv" style="border: 1px solid #e5e5e5;padding: 10px;background: #f3f3f3;height: 96px;"></div>
                                                 <span class="help-block">
                                                 <input type="hidden" id="sameasbilling2" name="sameasbilling" value="0" />
                                                 <label class="GFG"> <input type="checkbox" id="sameasbilling" name="sameasbilling" value="1"  <?php if ($_smarty_tpl->tpl_vars['invoice']->value && $_smarty_tpl->tpl_vars['invoice']->value->sameasbilling == '1') {?> checked <?php }?>  /> Same as Billing Address</label><a href="#" id="shipping_add" style="font-size: 14px;color:#6d6767;"> | Or Add New Shipping Address</a> </span>
                                            </div>
                                        </div>
...
<?php }?> -->
   ...
   <input type="hidden" name="m_address_shipping" id="m_address_shipping" <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_street;?>
" <?php }?>>
   <input type="hidden" name="city_shipping" id="city_shipping" <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_city;?>
" <?php }?>>
   <input type="hidden" name="state_shipping" id="state_shipping" <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_state;?>
" <?php }?>>
   <input type="hidden" name="zip_shipping" id="zip_shipping" <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_zip;?>
" <?php }?>>
   <input type="hidden" name="country_shipping" id="country_shipping" <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>value="<?php echo $_smarty_tpl->tpl_vars['invoice']->value->shipping_country;?>
" <?php }?>>
                  ...
                  <div class="col-sm-4">
                       <div class="form-group">
                        <label for="duedate">Original for buyer</label>
                            <select class="form-control" name="original_for_buyer" id="original_for_buyer">
                    ...
                    <div class="col-sm-4">
                       <div class="form-group">
                        <label for="duedate">Duplicate for Transporter</label>
                            <select class="form-control" name="duplicate_for_transporter" id="duplicate_for_transporter">
                            <option value="YES">YES</option>
                            <option value="NO">NO</option>
                            </select>
                        </div>
                    ...
                    <div class="col-sm-4">
                       <div class="form-group">
                        <label for="duedate">Third Copy for Supplier</label>
                            <select class="form-control" name="third_copy_supplier" id="third_copy_supplier">
                            <option value="YES">YES</option>
                            <option value="NO">NO</option>
                            </select>
                        </div>
...
">
                                                    <td colspan="2"><input type="text" class="form-control item_discount" name="discount[]" value="<?php echo numberFormatUsingCurrency($_smarty_tpl->tpl_vars['item']->value->discount_rate,$_smarty_tpl->tpl_vars['invoice']->value->currency_iso_code);?>
">
                                                    </td>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> </select></td>
 ...
 :</strong></td>
                            ...
                            <textarea class="form-control" name="bank_account_details" id="bank_account_details" rows="3" placeholder="Bank Account Details..."><?php if ($_smarty_tpl->tpl_vars['invoice']->value) {
...
/* {/block "content"} */
/* {block "script"} */
class Block_133969369360cad4b7ca8bf5_86401042 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_133969369360cad4b7ca8bf5_86401042',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> </select></td> <td class="ltotal"><input type="text" class="form-control lvtotal" readonly="" value=""></td>  </tr>'
            ...
            $modal.on('click', '.update', function () {
                ...
                $('input:checkbox:checked', tableControl).each(function () {
                    ...
                    $invoice_items.find('tbody')
                        .append(
                            '<tr>  <td><textarea class="form-control item_name" name="desc[]" rows="3" id="i_' + rowNum + '">' + item_name + '</textarea> <input type="hidden" name="item_code[]" value="' + item_code + '"><input type="hidden" name="is_tds[]" value="' + is_tds + '"> </td> <td><input type="text" class="form-control tax_code" value="" name="tax_code[]"></td>'  +
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> </select></td> <td class="ltotal"><input type="text" class="form-control lvtotal" readonly="" value=""></td>  </tr>'
 ...
 $modal.on('click', '.address_submit1', function (e) {
                  ...
                  if (address!='' && city!='' && state!='' && country!='' && zip!='') {
                   ...
                   var address_full='<div>'+address+'<br/>'+city+'<br/>'+state+' '+zip+'<br/>'+country+'</div>';
