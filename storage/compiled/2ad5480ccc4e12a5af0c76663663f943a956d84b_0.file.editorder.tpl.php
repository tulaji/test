<?php
/* Smarty version 3.1.36, created on 2021-04-28 17:20:13
  from 'C:\xampp\htdocs\pcrm\ui\theme\default\manufacturing\editorder.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_60894bf5c02a04_70313842',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2ad5480ccc4e12a5af0c76663663f943a956d84b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\pcrm\\ui\\theme\\default\\manufacturing\\editorder.tpl',
      1 => 1619468282,
      2 => 'file',
    ),
  ),
...
function content_60894bf5c02a04_70313842 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_127550701360894bf5b32d27_57027956', "head");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_19753999960894bf5b44035_74064423', "content");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_207914142360894bf5bcea40_86825458', 'script');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "head"} */
class Block_127550701360894bf5b32d27_57027956 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'head' => 
  array (
    0 => 'Block_127550701360894bf5b32d27_57027956',
  ),
);
...
/* {/block "head"} */
/* {block "content"} */
class Block_19753999960894bf5b44035_74064423 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_19753999960894bf5b44035_74064423',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['order_name'];?>
                                         ...
                                         <div class='col-md-4'>
                                            <div class='form-group'>
                                                ...
                                                <select id="team" name="team" class="form-control" onchange="selectteam(this.value)">
                                                        <option value="INTERNAL" <?php if ($_smarty_tpl->tpl_vars['d']->value['team'] == 'INTERNAL') {?> selected <?php }?> >INTERNAL</option>
                                                        <option value="EXTERNAL" <?php if ($_smarty_tpl->tpl_vars['d']->value['team'] == 'EXTERNAL') {?> selected <?php }?>>EXTERNAL</option>
                                                </select>
                                            </div>
                                        </div>

                                        <div class="col-md-4 <?php if ($_smarty_tpl->tpl_vars['d']->value['team'] != 'INTERNAL') {?> hideclass <?php }?>" id="selectuser">
                                            <div class='form-group'>
...
" <?php if ($_smarty_tpl->tpl_vars['d']->value['order_to'] == $_smarty_tpl->tpl_vars['cs']->value['id']) {?> selected <?php }?>  ><?php echo $_smarty_tpl->tpl_vars['cs']->value['fullname'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                         ...
                                         <div class="col-md-4 <?php if ($_smarty_tpl->tpl_vars['d']->value['team'] != 'EXTERNAL') {?> hideclass <?php }?>" id="selectsupplier" >
                                            <div class='form-group'>
                                                <label for="user_title">Select User</label>
...
" <?php if ($_smarty_tpl->tpl_vars['d']->value['order_to'] == $_smarty_tpl->tpl_vars['supplier']->value['id']) {?> selected <?php }?> ><?php echo $_smarty_tpl->tpl_vars['supplier']->value['account'];?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['start_date'];?>
" id="idate" name="start_date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true"
                                         ...
                                         <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['end_date'];?>
" id="idate" name="end_date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true"
                                                >
                                            </div>
                                        </div>
                                         <div class="col-sm-6">
...
" <?php if ($_smarty_tpl->tpl_vars['d']->value['project_id'] == $_smarty_tpl->tpl_vars['projects']->value['id']) {?> selected <?php }?>  ><?php echo $_smarty_tpl->tpl_vars['projects']->value['name'];?>
</option>
                                                    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                         ...
                                         <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="futuresave" name="futuresave" class="form-control" >
                                                        <option value="NO" <?php if ($_smarty_tpl->tpl_vars['d']->value['futuresave'] == 'NO') {?> selected <?php }?> >NO</option>
                                                        <option value="YES" <?php if ($_smarty_tpl->tpl_vars['d']->value['futuresave'] == 'YES') {?> selected <?php }?> >YES</option>
                                                </select>
                                            </div>
                                        </div>
                                   <input type="hidden" id="orderids" name="orderid" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
">
...
..." autofocus data-list=".list_pos_items"> </div>
 ...
 :</strong></td>
                            ...
                            <textarea class="form-control" name="notes" id="notes" rows="3"
                                      placeholder="Order Notes..."><?php echo $_smarty_tpl->tpl_vars['d']->value['order_note'];?>
</textarea>
                            <br>
...
/* {/block "content"} */
/* {block 'script'} */
class Block_207914142360894bf5bcea40_86825458 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_207914142360894bf5bcea40_86825458',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
",
            ...
            $("#save_n_close").click(function (e) {
                ...
                $('#ibox_form').block({ message: null });
                var _url = $("#_url").val();
                $.post(_url + 'morder/save_edit/', $('#invform').serialize(), function(data){
...
abc();
   function abc() {
    ...
    $.getJSON( base_url + "mitems/findbyorder_edit/"+orderid, function( data ) {

                   
     $.each( data, function( key, val ) {

        var pos_item_name, pos_item_price, pos_item_id, pos_item_number,avail_weight,price_per_kg,total_price,pos_item_weight,qtyused;
            ...
            pos_item_name=val.pos_item_name;
             ...
             var res=  _item_id.includes(pos_item_id); 
                ...
                if (res) {
                    ...
                    $invoice_items.find('tbody')
                    .prepend(
                        '<tr>  <td><input type="text" class="form-control item_name" name="name[]" rows="3" id="i_' + item_sl + '" value="' + pos_item_name + '" readonly> <input type="hidden" name="pos_item_id[]" value="' + pos_item_id + '"><input type="hidden" class="pos-item-weight" name="pos_item_weight[]" value="' + pos_item_weight + '"></td> <td><input type="text" class="form-control qty" value="'+avail_weight+'" name="avail_weight[]" readonly></td> <td><input type="text" class="form-control used_weight changable" data-avail_qty="'+val.avail_qty+'" data-valid="'+pos_item_id+'" id="used_weight_i_'+pos_item_id+'" name="used_weight[]" value="'+qtyused+'"></td><td><input type="text" data-valid="'+pos_item_id+'" class="form-control price_per_kg changable" name="price_per_kg[]" id="price_per_kg_i_'+pos_item_id+'" value="' + price_per_kg + '" readonly></td>  <td class="ltotal"><input type="text" class="form-control total_price" name="ttl_price[]" id="ttl_price_i_'+pos_item_id+'" value="'+total_price+'" readonly></td>  </tr>'
                    );
