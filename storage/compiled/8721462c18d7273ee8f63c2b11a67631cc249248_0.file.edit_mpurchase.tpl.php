<?php
/* Smarty version 3.1.36, created on 2021-04-28 19:10:00
  from 'C:\xampp\htdocs\pcrm\ui\theme\default\manufacturing\edit_mpurchase.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_608965b05c3fe5_66046247',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8721462c18d7273ee8f63c2b11a67631cc249248' => 
    array (
      0 => 'C:\\xampp\\htdocs\\pcrm\\ui\\theme\\default\\manufacturing\\edit_mpurchase.tpl',
      1 => 1619617190,
      2 => 'file',
    ),
  ),
...
function content_608965b05c3fe5_66046247 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1062592411608965b0527b07_31034192', "head");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1686972874608965b0539c71_52450975', "content");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_2030291511608965b0597dc7_77760323', 'script');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "head"} */
class Block_1062592411608965b0527b07_31034192 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'head' => 
  array (
    0 => 'Block_1062592411608965b0527b07_31034192',
  ),
);
...
/* {/block "head"} */
/* {block "content"} */
class Block_1686972874608965b0539c71_52450975 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_1686972874608965b0539c71_52450975',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['subject'];?>
" name="subject" id="subject">
                                       ...
                                       <!--  orderids -->
                                       <input type="hidden" name="orderids" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
" id="orderids">
                                        ...
                                        <div class='col-md-4'>
                                            <div class='form-group'>
                                                ...
                                                <select id="cid" name="cid" class="form-control">
                                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['suppliers']->value, 'cs');
...
" <?php if ($_smarty_tpl->tpl_vars['cs']->value['id'] == $_smarty_tpl->tpl_vars['d']->value['supplier']) {?> selected <?php }?> ><?php echo $_smarty_tpl->tpl_vars['cs']->value['account'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                        ...
                                        <div class='col-md-4'>
                                            <div class="form-group">
                                                ...
                                                <select id="status" name="status" class="form-control" >
                                                    <option  value="Published" <?php if ($_smarty_tpl->tpl_vars['d']->value['status'] == 'Published') {?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Published'];?>
</option>
                                                     <option  value="Draft" <?php if ($_smarty_tpl->tpl_vars['d']->value['status'] == 'Draft') {?> selected <?php }?>>Draft</option>
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['Issued_at'];?>
" id="idate" name="start_date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true"
                                                >
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive m-t">
                                <table class="table invoice-table" id="invoice_items">
                                    ...
                                    <tbody>
                                            ...
                                            <input type="hidden" id="sub_total_l" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['subtotal'];?>
"  name="sub_total" >
                                            <input type="hidden" id="tweight_l" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['tweight'];?>
"  name="tweight">
                                            <input type="hidden" id="total_l" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['total'];?>
"  name="total" >
                                            <input type="hidden" id="t_discount_l" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['total_discount'];?>
"  name="t_discount">
                                            <input type="hidden" id="t_tax_l" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['total_tax'];?>
"  name="t_tax">
 ...
 :</strong></td>
                            ...
                            <textarea class="form-control" name="notes" id="notes" rows="3"
                                      placeholder="Procurement Notes..."><?php echo $_smarty_tpl->tpl_vars['d']->value['note'];?>
</textarea>
                            <br>
...
/* {/block "content"} */
/* {block 'script'} */
class Block_2030291511608965b0597dc7_77760323 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_2030291511608965b0597dc7_77760323',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
storage/items/thumb'+ val.image;
            ...
            //start new 
             ...
             function previousload() {
                ...
                $.getJSON( base_url + "mitems/findbypurchase_edit/"+orderid, function( data ) {
                    var items = "";
                    var b_p;
                    $.each( data, function( key, val ) {

                        
                pos_item_number = val.pos_item_number;
                pos_item_name =val.description;
                pos_item_price =val.price
                pos_item_id =val.id;
                ...
                total_price =val.total;
                 ...
                 var lineweight=val.lineweight;
                  var linetax=val.tax;
                  var linetax_rate=val.tax_rate;
                  var linediscount=val.discount;
                  var line_discount_rate=val.discount_rate;
                  var line_subtotal=val.subtotal;
                  var line_total=val.total;
                  var lineqty=val.qty;
               ...
               if (res) {
                ...
                $invoice_items.find('tbody')
                    .prepend(
                        '<tr><td><input type="text" class="form-control item_name" name="name[]" rows="3" id="i_' + item_sl + '" value="' + pos_item_name + '" readonly> <input type="hidden" name="pos_item_id[]" value="' + pos_item_id + '" data-valid="'+pos_item_id+'"></td><td><input type="text" class="form-control qty changable" id="qty_'+pos_item_id+'" data-valid="'+pos_item_id+'" value="'+lineqty+'" name="qty[]" ></td><td><div class="row"><div class="col-md-6"><input type="text" class="form-control width changable" placeholder="Width" name="width[]" value="'+width+'" id="width_'+pos_item_id+'" data-valid="'+pos_item_id+'" readonly title="Width"></div><div class="col-md-6"><input type="text" class="form-control height changable" name="height[]"  value="'+height+'" id="height_'+pos_item_id+'" data-valid="'+pos_item_id+'" placeholder="Height" title="Height" readonly ></div><div class="col-md-6"><input type="text" class="form-control length changable" placeholder="Length" title="Length"  value="'+length+'" data-valid="'+pos_item_id+'" id="length_'+pos_item_id+'"  name="length[]" readonly></div><div class="col-md-6"><input type="text" class="form-control density changable" id="density_'+pos_item_id+'" title="Density"  value="'+density+'" placeholder="Density" data-valid="'+pos_item_id+'"  name="density[]" readonly><input type="hidden" value="'+item_type+'" data-valid="'+pos_item_id+'"  name="item_type[]" id="item_type_'+pos_item_id+'"/></div></div></td><td><input type="text" class="form-control cost_price changable" value="'+cost_price+'" data-valid="'+pos_item_id+'" name="cost_price[]" id="cost_price_'+pos_item_id+'"></td><td class="ltotal"><input type="number" value="'+line_discount_rate+'" class="form-control discount changable" name="discount[]" data-valid="'+pos_item_id+'" id="discount_'+pos_item_id+'" ></td><td class="ltotal"><input type="number" value="'+linetax_rate+'" class="form-control tax changable" name="tax[]" id="tax_'+pos_item_id+'"  data-valid="'+pos_item_id+'"  ></td><td class="ltotal"><input type="text" class="form-control ttl_price" value="'+line_total+'"  name="ttl_price[]" id="ttl_price_'+pos_item_id+'" data-valid="'+pos_item_id+'" readonly ><input type="hidden" name="line_tax[]" id="line_tax_'+pos_item_id+'" value="'+linetax+'"  class="line_tax" /><input type="hidden" value="'+lineweight+'"  name="line_weight[]" id="line_weight_'+pos_item_id+'" class="line_weight" /><input type="hidden" name="line_discount[]" id="line_discount_'+pos_item_id+'" class="line_discount" value="'+linediscount+'" /></td> </tr>'
                    );
