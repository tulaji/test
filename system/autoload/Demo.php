    ...
    public static function makeReady($country = ''){
        ...
        switch ($country){
            ...
            case 'nl':
                ...
                update_option('caddress','CloudOnex <br>STATIONSPLEIN 13A<br>INGANG \'DE CONDUCTEUR\'/ RECEPTIE OP -2 <br> 3818 LE Amersfoort <br> Netherlands');
...
');
        ...
        ORM::execute('INSERT INTO `bills` (`id`, `title`, `from_account_id`, `contact_id`, `category_id`, `start_date`, `next_date`, `last_paid_date`, `end_date`, `currency`, `net_amount`, `recurring_type`, `website`, `remind_days_before`, `add_transaction_automatically`, `is_active`, `is_paid`, `is_skipped`, `created_at`, `updated_at`) VALUES
(5, \'Digital Ocean Droplet\', 6, NULL, 14, NULL, \''.date('Y-m').'-09\', NULL, NULL, \'USD\', \'10.00000000\', \'Monthly\', \'https://cloud.digitalocean.com/login\', 0, 0, 1, 1, 0, \'2019-05-06 04:16:03\', \'2019-05-06 04:27:02\'),
(7, \'Office Rent\', NULL, NULL, 14, NULL, \''.date('Y-m').'-28\', NULL, NULL, \'USD\', \'1250.00000000\', \'Monthly\', NULL, 0, 0, 1, 0, 0, \'2019-05-06 04:17:06\', \'2019-05-06 04:19:13\'),
(8, \'Youtube Subscription\', NULL, NULL, 14, NULL, \''.date('Y-m').'-14\', NULL, NULL, \'USD\', \'11.99000000\', \'Monthly\', \'https://www.youtube.com/premium\', 0, 0, 1, 0, 0, \'2019-05-06 04:21:32\', \'2019-05-06 04:21:32\'),
(9, \'Facebook Ad\', NULL, NULL, 14, NULL, \''.date('Y-m',strtotime('+1 month')).'-04\', NULL, NULL, \'USD\', \'600.00000000\', \'Monthly\', NULL, 0, 0, 1, 0, 0, \'2019-05-06 04:23:05\', \'2019-05-06 04:23:28\'),
(10, \'T-Mobile Unlimited\', NULL, NULL, 14, NULL, \''.date('Y-m',strtotime('+1 month')).'-01\', NULL, NULL, \'USD\', \'70.00000000\', \'Monthly\', NULL, 0, 0, 1, 0, 0, \'2019-05-06 04:25:03\', \'2019-05-06 04:25:03\')');
