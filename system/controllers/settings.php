    ...
    case 'app-post':
        ...
        if (APP_STAGE == 'Demo') {
            ...
            $d->save();
             ...
             $d = ORM::for_table('sys_appconfig')
                ->where('setting', 'InvoiceBank')
                ->find_one();
            $d->value =_post('InvoiceBank');
            $d->save();

             $d = ORM::for_table('sys_appconfig')
                ->where('setting', 'invoicedeclaration')
                ->find_one();
            $d->value =_post('invoicedeclaration');
            $d->save();
        ...
        $min_material_bill_value = $_POST['min_material_bill_value'];
        $max_material_bill_value = $_POST['max_material_bill_value'];

        if (is_numeric($min_material_bill_value) and $min_material_bill_value != '') {
            $d = ORM::for_table('sys_appconfig')
                ->where('setting', 'min_material_bill_value')
                ->find_one();
            $d->value = $min_material_bill_value;
            $d->save();
        } else {
        ...
        if (is_numeric($max_material_bill_value) and $max_material_bill_value != '') {
            $d = ORM::for_table('sys_appconfig')
                ->where('setting', 'max_material_bill_value')
                ->find_one();
            $d->value = $max_material_bill_value;
            $d->save();
        } else {
            _msglog('e', $_L['Invalid Number']);
        }
