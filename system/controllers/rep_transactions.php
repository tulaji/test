...
Event::trigger('rep_transactions');
...
switch ($action) {
    case 'deposit':
        ...
        Event::trigger('rep_transactions/deposit/');
    ...
    case 'deposit-post':
        ...
        $data = $request->all();
        Event::trigger('rep_transactions/deposit-post/');
    ...
    case 'expense':
        Event::trigger('rep_transactions/expense/');
        $currencies = Currency::all();
        $currencies_all = Currency::getAllCurrencies();
    ...
    case 'expense-post':
        Event::trigger('rep_transactions/expense-post/');
    ...
    case 'transfer':
        Event::trigger('rep_transactions/transfer/');
        $currencies_all = Currency::getAllCurrencies();
        $d = ORM::for_table('sys_accounts')->find_many();
        $ui->assign('p', $d);
        $ui->assign('d', $d);
    ...
    case 'transfer-post':
        Event::trigger('rep_transactions/transfer-post/');
        $currency_iso_code = _post('currency');
    ...
    case 'list':
        Event::trigger('rep_transactions/list/');
        $cid = route(2);
        if ($cid == '' || $cid == '0') {
            $ui->assign('p_cid', '');
        } else {
    ...
    case 'a':
        Event::trigger('rep_transactions/a/');
        $d = ORM::for_table('sys_accounts')->find_many();
 ...
 '
    ...
    case 'list-income':
        Event::trigger('rep_transactions/list-income/');
        $ui->assign('selected_navigation', 'reports');
    ...
    vMax: \'9999999999999999.00\',
        ...
        view('rep_transactions');
        break;

    case 'list-expense':
        Event::trigger('rep_transactions/list-expense/');
        $ui->assign('selected_navigation', 'reports');
    ...
    case 'manage':
        Event::trigger('rep_transactions/manage/');
        $id = $routes['2'];
        ...
        if ($t) {
            ...
            r2(U . 'rep_transactions/list', 'e', $_L['Transaction_Not_Found']);
        }
    ...
    case 'edit-post':
        ...
        Event::trigger('rep_transactions/edit-post/');
    ...
    case 'delete-post':
        Event::trigger('rep_transactions/delete-post/');
        ...
        if (Transaction::remove($id)) {
            ...
            r2(
                U . 'rep_transactions/list',
                's',
                $_L['transaction_delete_successful']
            );
        } else {
            r2(U . 'rep_transactions/list', 'e', $_L['an_error_occured']);
        }

        break;

    case 's':
        Event::trigger('rep_transactions/s/');
        $d = ORM::for_table('sys_accounts')->find_many();
    ...
    case 'export_csv':
        Event::trigger('rep_transactions/export_csv/');
 ...
 '
    ...
    case 'mark-cleared':
        ...
        if ($transaction) {
            ...
            r2(U . 'rep_transactions/uncleared', 's', $_L['Data Updated']);
        }
    ...
    case 'delete-bill':
        ...
        r2(U . 'rep_transactions/bills', 's', $_L['delete_successful']);
    ...
    case 'bill-mark-as-paid':
        ...
        r2(U . 'rep_transactions/bills', 's', $_L['Data Updated']);
