...
<head>
    ...
    <style type="text/css">
        ...
        * { margin: 0; padding: 0; }
        ...
        textarea { border: 0; font-size: 14px; overflow: hidden; resize: none; }
        table { border-collapse: collapse; }
        table td, table th { border: 1px solid black; padding: 5px; }

        #header { height: 15px; width: 100%; margin: 20px 0; background: #222; text-align: center; color: white; font-size: 15px; text-decoration: uppercase; letter-spacing: 20px; padding: 8px 0px; }
...
<body  <?php if (isset($creating_pdf)) {
    echo 'style="font-family:dejavusanscondensed"';
} ?>>
...
<div id="page-wrap">
 ...
 ?></strong></span>
            ...
            <td style="border: 0;  text-align: right" width="62%"><div id="logo">
                    ...
                    <p style="font-size: 16px;"><?php echo $config[
                        'caddress'
                    ]; ?></p>
                </div></td>
        </tr>
        ...
        <table id="meta">
            <tr>
                ...
                <?php if (isset($d['title']) && $d['title'] != '') {
                    ...
                    <p><strong><?php echo $_L['Invoiced To']; ?></strong> </p>
                    <?php if ($a['company'] != '') { ?>
    ...
    <?php if ($config['tax_system'] == 'India') { ?>
        ...
        <table id="items">
            ...
            <tr>
                ...
                <th align="right"><?php echo 'HSN/SAC'; ?></th>
        ...
        ?><!--</th>-->
            ...
            <tr>
                <td class="blank"> </td>
                <td colspan="3" class="total-line"><?php echo $_L[
                    'Sub Total'
                ]; ?></td>
            ...
            <?php if ($d['credit'] != '0.00') { ?>
                ...
                <tr>
                    <td class="blank"> </td>
                    <td colspan="3" class="total-line balance"><?php echo $_L[
                        'Amount Due'
                    ]; ?></td>
    ...
    <?php if ($d['notes'] != '') { ?>
        ...
        <?php } ?>
    <?php if (!isset($creating_pdf)) { ?>
        <button class='button -dark center no-print'  onClick="window.print();"><?php echo $_L[
            'Print'
        ]; ?></button>
    <?php } ?>
</div>
