...
{if $d['shippingid'] != '0' }
{$d['shipping_street']} <br>
{$d['shipping_city']} <br>
{$d['shipping_state']} {$d['shipping_zip']} <br>
{$d['shipping_country']}
{else}
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{$item['qty']}</td>
                                     <td class="text-center">
                                                     ...
                                                     {formatCurrency($item['tds_value'],$d['currency_iso_code'])}

                                                       <br>
                                                        @{round($item['tds_rate'],2)}%
                                    ...
                                    {if $d['is_same_state']}
                                        ...
                                        <td class="text-right">
                                            <span class="amount" data-a-sign="{$data_a_sign}" data-a-dec="{$data_a_dec}" data-a-sep="{$data_a_sep}" data-p-sign="{$data_p_sign}">{gstIndiaSplitTaxValue($item['total_notds'],$item['tax_rate'])}</span>
                                            <br>
                        ...
                        <div class="col-sm-4 offset-md-8 ">
                            <table class="table h5 text-dark">
                                ...
                                {/if}
                                  ...
                                  {if ($d['tds_value']) neq '0.00'}
                                                <tr>
                                                    <td colspan="2">TDS Total</td>
                                                    <td class="text-left">{formatCurrency($d['tds_value'],$d['currency_iso_code'])}</td>
                                                </tr>
                                            {/if}
