                        ...
                        <div class="panel-content">
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{$d['subject']}" name="subject" id="subject">
                                       ...
                                       <!--  orderids -->
                                       <input type="hidden" name="orderids" value="{$d['id']}" id="orderids">
                                            ...
                                            <div class='form-group'>
                                                ...
                                                <select id="cid" name="cid" class="form-control">
                                                    {foreach $suppliers as $cs}
                                                        <option value="{$cs['id']}" {if $cs['id'] eq $d['supplier']} selected {/if} >{$cs['account']} {if $cs['email'] neq ''}- {$cs['email']}{/if}</option>
                                                    {/foreach}
                                        ...
                                        <div class='col-md-4'>
                                            <div class="form-group">
                                                ...
                                                <select id="status" name="status" class="form-control" >
                                                    <option  value="Published" {if $d['status'] eq 'Published'} selected {/if}>{$_L['Published']}</option>
                                                     <option  value="Draft" {if $d['status'] eq 'Draft'} selected {/if}>Draft</option>
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{$d['Issued_at']}" id="idate" name="start_date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true"
                                                >
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive m-t">
                                <table class="table invoice-table" id="invoice_items">
                                    ...
                                    <tbody>
                                            ...
                                            <input type="hidden" id="sub_total_l" value="{$d['subtotal']}"  name="sub_total" >
                                            <input type="hidden" id="tweight_l" value="{$d['tweight']}"  name="tweight">
                                            <input type="hidden" id="total_l" value="{$d['total']}"  name="total" >
                                            <input type="hidden" id="t_discount_l" value="{$d['total_discount']}"  name="t_discount">
                                            <input type="hidden" id="t_tax_l" value="{$d['total_tax']}"  name="t_tax">
                           ...
                           <!--  <button type="button" class="btn btn-danger" id="item-remove"><i
                            ...
                            <textarea class="form-control" name="notes" id="notes" rows="3"
                                      placeholder="Procurement Notes...">{$d['note']}</textarea>
                            <br>
