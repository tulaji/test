                        ...
                        <div class="panel-content">
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{$d['order_name']}" name="subject" id="subject">
                                         ...
                                         <div class='col-md-4'>
                                            <div class='form-group'>
                                                ...
                                                <select id="team" name="team" class="form-control" onchange="selectteam(this.value)">
                                                        <option value="INTERNAL" {if $d['team'] eq 'INTERNAL' } selected {/if} >INTERNAL</option>
                                                        <option value="EXTERNAL" {if $d['team'] eq 'EXTERNAL' } selected {/if}>EXTERNAL</option>
                                                </select>
                                            </div>
                                        </div>

                                        <div class="col-md-4 {if $d['team'] neq 'INTERNAL' } hideclass {/if}" id="selectuser">
                                            <div class='form-group'>
                                                <label for="user_title">Select User</label>
                                                <select id="cid" name="cid" class="form-control">
                                                    <option value="">{$_L['Select Contact']}...</option>
                                                    {foreach $c as $cs}
                                                        <option value="{$cs['id']}" {if $d['order_to'] eq $cs['id'] } selected {/if}  >{$cs['fullname']} {if $cs['email'] neq ''}- {$cs['email']}{/if}</option>
                                                    {/foreach}

                                                </select>
                                            </div>
                                        </div>
                                         <div class="col-md-4 {if $d['team'] neq 'EXTERNAL' } hideclass {/if}" id="selectsupplier" >
                                            <div class='form-group'>
                                                <label for="user_title">Select User</label>
                                                <select id="cid1" name="cid1" class="form-control">
                                                    <option value="">{$_L['Select Contact']}...</option>
                                                    {foreach $suppliers as $supplier}
                                                        <option value="{$supplier['id']}" {if $d['order_to'] eq $supplier['id'] } selected {/if} >{$supplier['account']} {if $supplier['email'] neq ''}- {$supplier['email']}{/if}</option>
                                                    {/foreach}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{$d['start_date']}" id="idate" name="start_date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true"
                                                >
                                            </div>
                                        </div>
                                         <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{$d['end_date']}" id="idate" name="end_date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true"
                                                >
                                            </div>
                                        </div>
                                         <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="project_id" name="project_id" class="form-control">
                                                    ...
                                                    {foreach $clx_projects as $projects}
                                                        <option value="{$projects['id']}" {if $d['project_id'] eq $projects['id']} selected {/if}  >{$projects['name']}</option>
                                                    {/foreach}
                                         ...
                                         <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="futuresave" name="futuresave" class="form-control" >
                                                        <option value="NO" {if $d['futuresave'] eq 'NO'} selected {/if} >NO</option>
                                                        <option value="YES" {if $d['futuresave'] eq 'YES'} selected {/if} >YES</option>
                                                </select>
                                            </div>
                                        </div>
                                   <input type="hidden" id="orderids" name="orderid" value="{$d['id']}">
                                         ...
                                         <div class='col-sm-12' id="selectfeatured" >
                                            <div class='form-group'>
                                                ...
                                                <select id="features" name="features" class="form-control" >
                                                    ...
                                                    {foreach $sys_morder as $_morder}
                                                        <option value="{$_morder['id']}"  >{$_morder['order_name']}-{$_morder['orderid']}</option>
                                                    {/foreach}
                           ...
                           <!--  <button type="button" class="btn btn-danger" id="item-remove"><i
                            ...
                            <textarea class="form-control" name="notes" id="notes" rows="3"
                                      placeholder="Order Notes...">{$d['order_note']}</textarea>
                            <br>
