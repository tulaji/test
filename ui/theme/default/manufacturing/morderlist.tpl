            ...
            <div class="panel">
                ...
                <div class="panel-hdr">
                    ...
                    <div class="panel-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{$_url}morder/add" class="btn btn-primary"><i class="fal fa-plus"></i> Create Bill</a>
                            ...
                            <table class="table table-striped w-100" id="clx_datatable">
                                ...
                                {foreach $items as $item}
                                    <tr>
                                        ...
                                        <td>
                                        {if $item->order_status eq 'NOT-APPROVED'}
                                        <span style="color:red">Waiting for Approval</span>
                                        {else}
                                        <span style="color:green">{$item->order_status}</span>
                                        {/if}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group float-right">
                                                 ...
                                                 <a href="{$_url}morder/view/{$item->id}/" class="btn btn-primary btn-icon" data-toggle="tooltip" data-placement="top" title="{$_L['View']}"><i class="fal fa-file-alt"></i></a>
                                               
                                               {if $item['order_status'] eq 'NEW' || $item['order_status'] eq 'NOT-APPROVED' || $item['order_status'] eq 'CANCELLED' || $item['order_status'] eq 'APPROVED'}
                                                <a href="javascript:;" onclick="confirmThenGoToUrl(event,'morder/delete/{$item->id}')"  class="btn btn-danger btn-icon waves-effect waves-themed has-tooltip" data-title="{$_L['Delete']}" data-placement="top"><i class="fal fa-trash-alt"></i> </a>
                                                {else}
