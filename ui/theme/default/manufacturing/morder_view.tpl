                ...
                <div class="panel-hdr">
                    ...
                    <div class="panel-toolbar">
                        <div class="btn-group flex-wrap" role="group">
                           ...
                           {if $d['order_status'] eq 'NEW' || $d['order_status'] eq 'NOT-APPROVED' || $d['order_status'] eq 'CANCELLED' || $d['order_status'] eq 'APPROVED'}
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                     <li class="dropdown-item"><a href="#" class="orderstatus" data-id="{$d['id']}" data-status="APPROVED">APPROVED</a></li>
                                     <li class="dropdown-item"><a href="#" class="orderstatus" data-id="{$d['id']}" data-status="CANCELLED">CANCELLED</a></li>
                            ...
                            {if $d['order_status'] eq 'NEW' || $d['order_status'] eq 'NOT-APPROVED' || $d['order_status'] eq 'CANCELLED' || $d['order_status'] eq 'APPROVED'}
                            <a href="{$_url}morder/edit_bill/{$d['id']}" class="btn btn-warning  btn-sm"><i class="fal fa-pencil"></i> <span class="d-none d-md-inline">{$_L['Edit']}</span></a>
                            {/if}
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li class="dropdown-item"><a href="{$_url}morder/pdf/{$d['id']}/token_{$d['vtoken']}/view/" target="_blank">{$_L['View PDF']}</a></li>
                                    <li class="dropdown-item"><a href="{$_url}morder/pdf/{$d['id']}/azpllldd/dl/">{$_L['Download PDF']}</a></li>
                                </ul>
                            </div>
                            <a href="{$_url}morder/print_bill/{$d['id']}" target="_blank" class="btn btn-dark  btn-sm"><i class="fal fa-print"></i>  <span class="d-none d-md-inline">{$_L['Print']}</span></a>
                            ...
                            <header class="clearfix">
                                <div class="row">
                                    <div class="col-sm-6 mt-md">
                                        <h2 class="h2 mt-none mb-sm text-dark text-bold">Bill No :#{$d['orderid']}</h2>
                                       

                                        {if $d['order_status'] eq 'NOT-APPROVED'}
                                            <h3 class="alert alert-danger">PENDING FOR APPROVAL</h3>
                                        {elseif $d['order_status'] eq 'PROCESSING'}
                                            <h3 class="alert alert-success">WORK IN PROGRESS</h3>
                                        {elseif $d['order_status'] eq 'FINISHED'}
                                            <h3 class="alert alert-info">FINISHED</h3>
                                        {elseif $d['order_status'] eq 'APPROVED'}
                                            <h3 class="alert alert-info">APPROVED</h3>
                                         {elseif $d['order_status'] eq 'TRANSFER'}
                                            <h3 class="alert alert-info">FINISHED AND TRANSFERED</h3>
                                     
                                        {elseif $d['order_status'] eq 'CANCELLED'}
                                            <h3 class="alert alert-danger">CANCELLED</h3>
                                        {else}
                                            <h3 class="alert alert-info">{$d['order_status']}</h3>
                                        {/if}
