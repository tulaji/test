            ...
            <div class="panel">
                ...
                <div class="panel-hdr">
                    ...
                    <div class="panel-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{$_url}mps/p-new" class="btn btn-primary"><i class="fal fa-plus"></i> {$_L['Add Product']}</a>
                                ...
                                {foreach $items as $item}
                                    <tr>
                                        ...
                                        {$item->inventory*$item->weight}
                                         ...
                                         <td>
                                            {formatCurrency(($item->cost_price*$item->inventory),$config['home_currency'],$format_currency_override)}
