                ...
                <div class="panel-hdr">
                    ...
                    <div class="panel-toolbar">
                        <div class="btn-group flex-wrap" role="group">
                            ...
                            <a href="{$_url}mpurchase/edit_mpurchase/{$d['id']}" class="btn btn-warning  btn-sm"><i class="fal fa-pencil"></i> <span class="d-none d-md-inline">{$_L['Edit']}</span></a>
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li class="dropdown-item"><a href="{$_url}mpurchase/pdf/{$d['id']}/token_{$d['vtoken']}/view/" target="_blank">{$_L['View PDF']}</a></li>
                                    <li class="dropdown-item"><a href="{$_url}mpurchase/pdf/{$d['id']}/azpllldd/dl/">{$_L['Download PDF']}</a></li>
                                </ul>
                            </div>
                            <a href="{$_url}mpurchase/print_mpurchase/{$d['id']}" target="_blank" class="btn btn-dark  btn-sm"><i class="fal fa-print"></i>  <span class="d-none d-md-inline">{$_L['Print']}</span></a>
                            ...
                            <header class="clearfix">
                                <div class="row">
                                    <div class="col-sm-6 mt-md">
                                        <h2 class="h2 mt-none mb-sm text-dark text-bold">Procurement No :#{$d['pruchase_ref']}</h2>
                                    ...
                                    <div class="col-md-6">
                                        <div class="bill-data text-right">
                                            <p class="mb-none">
                                                ...
                                                <span class="value">{date( $config['df'], strtotime($d['Issued_at']))}</span>
                                            </p>
