                        ...
                        <form role="form" name="accadd" method="post" action="{$_url}settings/app-post">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="min_material_bill_value" name="min_material_bill_value"
                                       value="{$config['min_material_bill_value']}">
                            </div>
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="max_material_bill_value" name="max_material_bill_value"
                                       value="{$config['max_material_bill_value']}">
                            </div>
                           ...
                           <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="InvoiceBank" name="InvoiceBank"
                                       value="{$config['InvoiceBank']}">{$config['InvoiceBank']}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="invoicedeclaration" name="invoicedeclaration"
                                       value="{$config['invoicedeclaration']}">{$config['invoicedeclaration']}</textarea>
