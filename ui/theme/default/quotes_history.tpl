            ...
            <div class="panel-content">
                <div class="table-responsive">
                    <table class="table table-striped w-100" id="clx_datatable">
                        ...
                        {foreach $d as $ds}
                            <tr>  
                                <td data-value="{$ds['id']}" data-order="{$ds@iteration}"><a href="{$_url}quotes/view/{$ds['id']}/">{$ds['invoicenum']}{if $ds['cn_version'] neq ''} {$ds['cn_version']} {else} {$ds['id']} {/if}</a> </td>
                                ...
                                <td class="text-right">
                                    <div class="btn-group">
                                        <a href="{$_url}quotes/viewhistory/{$ds['id']}/" class="btn btn-primary btn-icon waves-effect waves-themed has-tooltip" data-title="{$_L['View']}" data-placement="top"><i class="fal fa-file"></i> </a>
