                    ...
                    <div class="panel-hdr">
                        <h2>
                            {if $invoice}
                                ...
                                {$_L['Invoice']} - {$invoice->invoicenum}{if $invoice->cn neq ''} {$invoice->cn}
                                {else}
                                {$invoice->id} {/if}
                                ...
                                <div class="col-md-12">
                                    <div class='row'>
                                                ...
                                                <select id="cid" name="cid" class="form-control">
                                                    ...
                                                    {foreach $c as $cs}
                                                        <option value="{$cs['id']}"
                                                            ...
                                                            {if $cs['company'] neq ''} {$cs['company']} - {/if} {$cs['account']}
                                                            {if $cs['email'] neq ''}- {$cs['email']}{/if}</option>
                                                    {/foreach}

                                                </select>
                                                <span class="help-block"><a href="#" id="contact_add">|
                                                        {$_L['Or Add New Customer']}</a> </span>
                                            </div>
                                        </div>
                                        <div class='col-sm-4'>
                                            <div class="form-group">
                                                ...
                                                <select id="status" name="status" class="form-control">
                                                    ...
                                                    <option value="Published"
                                                        {if $invoice && $invoice->status != 'Draft'}selected{/if}>
                                                        {$_L['Published']}</option>
                                                    <option value="Draft"
                                                        {if $invoice && $invoice->status == 'Draft'}selected{/if}>
                                                        {$_L['Draft']}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="currency" name="currency" class="form-control">
                                                    ...
                                                    {foreach $currencies as $key=>$value}
                                                        <option value="{$key}" {if $invoice}
                                                                {if $invoice->currency_iso_code == $key}selected {/if} {else}
                                                                {if $config['home_currency'] eq ($key)}selected {/if} {/if}
                                                                data-decimal-mark="{$value['decimal_mark']}"
                                                                data-thousands-separator="{$value['thousands_separator']}"
                                                                data-symbol="{$value['symbol']}" {if $value['symbol_first']}
                                                                data-symbol-first="yes" {else} data-symbol-first="no" 
                                                                {/if}>{$key}
                                                            </option>
                                                        {foreachelse}
                                                        {/foreach}
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="invoice_title">{$_L['Title']}
                                                        <small><em>({$_L['optional']})</em></small></label>

                                                    <input type="text" class="form-control" id="invoice_title" name="title"
                                                        {if $invoice}value="{$invoice->title}" {/if}>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='row'>
                                            <div class='col-sm-6'>
                                                <div class="form-group">
                                                    <label for="address">{$_L['Billing Address']}</label>
                                                    <textarea id="address" readonly class="form-control" rows="5"></textarea>
                                                </div>
                                            </div>
                                            <div class='col-sm-6'>
                                                <div class="form-group">
                                                    <label for="shippingaddress">{$_L['Shipping Address']}</label>
                                                    ...
                                                    <span class="help-block">
                                                        ...
                                                        <label class="GFG"> <input type="checkbox" id="sameasbilling"
                                                                ...
                                                                {if $invoice && $invoice->sameasbilling=='1'} checked {/if} />
...
{/if} -->
                                            ...
                                            <div class='col-sm-6'>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="invoicenum" name="invoicenum"
                                                        {if $invoice}value="{$invoice->invoicenum}" 
                                                        {else}
                                                        value="{$config['invoice_code_prefix']}" {/if}>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="cn" name="cn"
                                                        {if $invoice}value="{$invoice->cn}" 
                                                        {else}
                                                            value="{str_pad($config['invoice_code_current_number'], $config['number_pad'], '0', STR_PAD_LEFT)}"
                                                        {/if}>
                                            ...
                                            <div class='col-sm-6'>
                                                {if $config['invoice_receipt_number'] eq '1'}
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="receipt_number"
                                                            name="receipt_number" {if $invoice}value="{$invoice->receipt_number}"
                                                            {/if}>
                                                    </div>
                                                {else}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="show_quantity_as"
                                                        name="show_quantity_as" {if $invoice}
                                                        value="{$invoice->show_quantity_as}" {else}
                                                ...
                                                {if $recurring}
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="repeat" id="repeat">
                                                            <option value="daily" {if $invoice && $invoice->r == '+1 day'}
                                                                selected{/if}>{$_L['Daily']}</option>
                                                            <option value="week1" {if $invoice && $invoice->r == '+1 week'}
                                                                selected{/if}>{$_L['Weekly']}</option>
                                                            <option value="weeks2" {if $invoice && $invoice->r == '+2 weeks'}
                                                                selected{/if}>{$_L['Weeks_2']}</option>
                                                            <option value="weeks3" {if $invoice && $invoice->r == '+3 weeks'}
                                                                selected{/if}>{$_L['Weeks_3']}</option>
                                                            <option value="weeks4" {if $invoice && $invoice->r == '+4 weeks'}
                                                                selected{/if}>{$_L['Weeks_4']}</option>
                                                            <option value="month1" {if $invoice} 
                                                                {if $invoice->r == '+1 month'}
                                                                    selected{/if} 
                                                                    {else} selected 
                                                                    {/if}>{$_L['Month']}</option>
                                                                <option value="months2" {if $invoice && $invoice->r == '+2 months'}
                                                                    selected{/if}>{$_L['Months_2']}</option>
                                                                <option value="months3" {if $invoice && $invoice->r == '+3 months'}
                                                                    selected{/if}>{$_L['Months_3']}</option>
                                                                <option value="months6" {if $invoice && $invoice->r == '+6 months'}
                                                                    selected{/if}>{$_L['Months_6']}</option>
                                                                <option value="year1" {if $invoice && $invoice->r == '+1 year'}
                                                                    selected{/if}>{$_L['Year']}</option>
                                                                <option value="years2" {if $invoice && $invoice->r == '+2 years'}
                                                                    selected{/if}>{$_L['Years_2']}</option>
                                                                <option value="years3" {if $invoice && $invoice->r == '+3 years'}
                                                                    selected{/if}>{$_L['Years_3']}</option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="place_of_supply" name="place_of_supply" class="form-control">
                                                                ...
                                                                {if $invoice}
                                                                    ...
                                                                    <option value="{$config['business_location']}"
                                                                        {if $invoice->is_same_state == 1} selected{/if}>
                                                                        {$config['business_location']}</option>
                                                                    <option value="other" {if $invoice->is_same_state == 0} selected{/if}>
                                                                        Other</option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="idate" name="idate" datepicker
                                                            data-date-format="yyyy-mm-dd" data-auto-close="true" {if $invoice}
                                                            value="{$invoice->date}" {else} value="{$idate}" 
                                                            {/if}>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                        ...
                                                        {else}
                                                            ...
                                                            <select class="form-control" name="duedate" id="duedate">
                                                                <option value="due_on_receipt"
                                                                    {if isset($config['invoice_default_date']) && ($config['invoice_default_date'] == 'due_on_receipt' )}
                                                                    selected{/if}>{$_L['Due On Receipt']}</option>
                                                                <option value="days3"
                                                                    {if isset($config['invoice_default_date']) && ($config['invoice_default_date'] == 'days3' )}
                                                                    selected{/if}>{$_L['days_3']}</option>
                                                                <option value="days5"
                                                                    {if isset($config['invoice_default_date']) && ($config['invoice_default_date'] == 'days5' )}
                                                                    selected{/if}>{$_L['days_5']}</option>
                                                                <option value="days7"
                                                                    {if isset($config['invoice_default_date']) && ($config['invoice_default_date'] == 'days7' )}
                                                                    selected{/if}>{$_L['days_7']}</option>
                                                                <option value="days10"
                                                                    {if isset($config['invoice_default_date']) && ($config['invoice_default_date'] == 'days10' )}
                                                                    selected{/if}>{$_L['days_10']}</option>
                                                                <option value="days15"
                                                                    {if isset($config['invoice_default_date']) && ($config['invoice_default_date'] == 'days15' )}
                                                                    selected{/if}>{$_L['days_15']}</option>
                                                                <option value="days30"
                                                                    {if isset($config['invoice_default_date']) && ($config['invoice_default_date'] == 'days30' )}
                                                                    selected{/if}>{$_L['days_30']}</option>
                                                                <option value="days45"
                                                                    {if isset($config['invoice_default_date']) && ($config['invoice_default_date'] == 'days45' )}
                                                                    selected{/if}>{$_L['days_45']}</option>
                                                                <option value="days60"
                                                                    {if isset($config['invoice_default_date']) && ($config['invoice_default_date'] == 'days60' )}
                                                                    selected{/if}>{$_L['days_60']}</option>
                                                            </select>
                                    ...
                                    <div class="table-responsive mt-3">
                                            ...
                                            <table class="table table-bordered invoice-table" id="invoice_items">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th rowspan="2">
                                                            {if $config['show_quantity_as'] eq ''}{$_L['Qty']}{else}{$config['show_quantity_as']}{/if}
                                                        </th>
                                                            ...
                                                            {if $invoice}
                                                                ...
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeF" type="radio"
                                                                        ...
                                                                        {if $invoice->discount_type == 'f'}checked{/if}>Rs
                                                                </label>
                                                        ...
                                                        {foreach $items as $item}
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input type="hidden" name="is_tds[]" value="{$item->tds_deduction}">
                                                                    <input type="hidden" name="item_code[]" value="{$item->itemcode}">
                                                                </td>
                                                                <td><input type="text" class="form-control tax_code" value="{$item->tax_code}"
                                                                        name="tax_code[]"></td>
                                                                <td><input type="text" class="form-control qty"
                                                                        value="{numberFormatUsingCurrency($item->qty,$invoice->currency_iso_code)}"
                                                                        name="qty[]"></td>
                                                                <td><input type="text" class="form-control item_price" name="amount[]"
                                                                        value="{numberFormatUsingCurrency($item->amount,$invoice->currency_iso_code)}">
                                                                <td colspan="2"><input type="text" class="form-control item_discount"
                                                                        name="discount[]"
                                                                        value="{numberFormatUsingCurrency($item->discount_rate,$invoice->currency_iso_code)}">
                                                                </td>
                                                                    ...
                                                                    <select class="form-control taxed" name="taxed[]">
                                                                        ...
                                                                        {foreach $t as $ts}
                                                                            <option value="{$ts['rate']}"
                                                                                {if $ts['rate'] eq $item['tax_rate']}selected{/if}>{$ts['name']}
                                                                            </option>
                                                                        {/foreach}
                                            ...
                                            <table class="table table-bordered invoice-table" id="invoice_items">
                                                        ...
                                                        <th colspan="2">
                                                            ...
                                                            {if $invoice}
                                                                ...
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeP" type="radio"
                                                                        name="discount_type" value="p"
                                                                        {if $invoice->discount_type == 'p'}checked{/if}> <span
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        title="{$_L['Percentage']}">%</span>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeF" type="radio"
                                                                        name="discount_type" value="f"
                                                                        {if $invoice->discount_type == 'f'}checked{/if}> <span
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        title="{$_L['Fixed Amount']}" id="fixedDiscountText">
                                                            ...
                                                            {else}
                                                                ...
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeP" type="radio"
                                                                        ...
                                                                        data-placement="top" title="{$_L['Percentage']}">%</span>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input class="discountType" id="discountTypeF" type="radio"
                                                                        name="discount_type" value="f"> <span data-toggle="tooltip"
                                                                        data-placement="top" title="{$_L['Fixed Amount']}"
                                                ...
                                                <tbody>
                                                    ...
                                                    {if $items}
                                                        ...
                                                        {foreach $items as $item}
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2"><input type="text" class="form-control item_discount"
                                                                        name="discount[]"
                                                                        value="{numberFormatUsingCurrency($item->discount_amount,$invoice->currency_iso_code)}">
                                                                </td>
                                                                <td><select class="form-control taxed" name="taxed[]">
                                                                        {foreach $t as $ts}
                                                                            <option value="{$ts['rate']}"
                                                                                {if $item->tax_rate eq $ts['rate']}selected{/if}>{$ts['name']}
                                                                            </option>
                                                                        {/foreach}
                                                                    </select></td>
                                                    ...
                                                    <!--    <tr>
                                                            ...
                                                            {if $ts['is_default'] eq '1'}selected
                                        ...
                                        <button type="button" class="btn btn-primary" id="item-add"><i class="fal fa-search"></i>
                                            {$_L['Add Product OR Service']}</button>
                                        ...
                                        <textarea class="form-control" name="bank_account_details" id="bank_account_details" rows="3"
                                            placeholder="Bank Account Details...">{if $invoice}{$invoice->bank_account_details} {else} {$config['InvoiceBank']} {/if}</textarea>
                                        <br>
                                        ...
                                        <textarea class="form-control" name="declaration" id="declaration" rows="3"
                                            placeholder="Declaration...">{if $invoice}{$invoice->declaration} {else} {$config['invoicedeclaration']} {/if}</textarea>
                                        <br>
                            ...
                            {else}
                                ...
                                $invoice_items.find('tbody')
                                    .append(
                                        ...
                                        {/foreach} </select></td> <td class="ltotal"><input type="text" class="form-control lvtotal" readonly="" value=""></td>  </tr>'
                                    );
                                ...
                                {if $config['tax_system'] == 'India'}
                                    ...
                                    $invoice_items.find('tbody')
                                        .prepend(
                                            ...
                                            '"> </td> <td><input type="text" class="form-control tax_code" value="" name="tax_code[]"></td>' +
                                            ' <td><input type="text" class="form-control qty" value="1" name="qty[]"></td> <td><input type="text" class="form-control item_price" name="amount[]" value="' + pos_item_price + '"></td> <td colspan="2"><input type="text" class="form-control item_discount" value="0.00" name="discount[]"></td>  <td> <select class="form-control taxed" name="taxed[]" id="t_' + item_sl + '"> {foreach $t as $ts}  <option value="{$ts['rate']}" 
