                    ...
                    <div class="panel-content" id="ibox_form">
                        <form id="invform" method="post">
                            <div class="ibox-content">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                             ...
                                             {if $d['stage'] eq 'Accepted'} {else}style="display:none;"{/if} >
                                                ...
                                                <select id="pid" name="pid" class="form-control">
                                                    ...
                                                    {foreach $avail_projects as $csp}
                                                        <option value="{$csp['id']}"
                                                                {if $d['pid'] eq $csp['id']}selected="selected" {/if}> {$csp['name']}</option>
                                                    {/foreach}
                                        ...
                                        <table class="table invoice-total">
                                            ...
                                            <tr>
                                              ...
                                              <tr>
                                                ...
                                                <td id="tds" class="amount" data-a-sign="" data-a-dec="{$config['dec_point']}"
                                                    data-a-sep="" data-d-group="2">{$d['tds_deduction']}
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <hr>
                                 <input type="hidden" name="last_amount" value="{$d['total']}">
                                                <input type="hidden" name="last_tax" value="{$d['tax1']}">
                                                <input type="hidden" name="last_discount" value="{$d['discount']}">
                                                <input type="hidden" name="last_tds" value="{$d['tds_deduction']}">
