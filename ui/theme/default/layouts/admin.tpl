        ...
        <div class="page-logo">
            <a href="{$_url}dashboard" class="page-logo-link d-flex align-items-center position-relative">
                ...
                {if isset($config['logo_square'])}
                    <img src="{{APP_URL}}/storage/system/{{$config['logo_square']}}" alt="{{$config['CompanyName']}}"
                        aria-roledescription="logo">
                {else}
                    <img src="{{APP_URL}}/storage/system/logo-512x512.png?v=2" alt="{{$config['CompanyName']}}"
                        aria-roledescription="logo">
                {/if}
            ...
            <ul id="js-nav-menu" class="nav-menu">
                ...
                <li class="{if $selected_navigation eq 'util'}active open{/if}">
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="{$_url}user_clinic/add"><span class="nav-link-text">Add Clinic Data</span></a></li>
                        <li><a href="{$_url}user_clinic/view"><span class="nav-link-text">Generate Pass</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="{if $selected_navigation eq 'util'}active open{/if}">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="{$_url}util/dbstatus"><span class="nav-link-text">{$_L['Database Status']}</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="{if $selected_navigation eq 'appearance'}active open{/if}" id="li_appearance">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="{$_url}appearance/ui"><span class="nav-link-text">{$_L['User Interface']}</span></a>
                        </li>
                        <li><a href="{$_url}appearance/customize"><span class="nav-link-text">{$_L['Customize']}</span></a>
                        </li>
                ...
                <li class="{if $selected_navigation eq 'settings'}active open{/if}" id="li_settings">
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="{$_url}settings/app"><span class="nav-link-text">{$_L['General Settings']}</span></a>
                        </li>
                    </ul>
                </li>
            </ul>
    ...
    <div class="page-content-wrapper">
        <header class="page-header" role="banner">
            ...
            <div class="ml-auto d-flex">
                ...
                <div>
                    <a href="#" data-toggle="dropdown" title="{$user->fullname}"
                                ...
                                <span class="mr-2">
                                    ...
                                    {if $user['img'] eq ''}
                                        <img src="{$app_url}ui/lib/img/default-user-avatar.png"
                                            class="rounded-circle profile-image" alt="{$user->fullname}">
                                    {else}
                ...
                <div class="modal-content h-100">
                    ...
                    <div class="modal-body p-0 h-100 d-flex">
                        <textarea class="form-control rounded-0" id="clx_notes_clipboard"
                            placeholder="{$_L['Whats on your mind']}">{$user->notes}</textarea>
                    </div>
                </div>
            </div>
        </div>
