    ...
    <div class="row mt-2">
        <div class="col-md-6">
            <div class="form-group h6"><label for="city"><span class="h6">Company Type</span></label>
                ...
                <option value="OnePerson" {if $d['company_type'] eq ('OnePerson')}selected="selected" {/if}  >One Person Company</option>

                 <option  value="LLP" {if $d['company_type'] eq ('LLP')}selected="selected" {/if}  >Limited Liability Partnership(LLP)</option>

                 <option  value="PublicLimited" {if $d['company_type'] eq ('PublicLimited')}selected="selected" {/if}  >Public Limited Company</option>


                <option value="PrivateLimited" {if $d['company_type'] eq ('PrivateLimited')}selected="selected" {/if}  >Private Limited Company</option>

                <option value="Partnership" {if $d['company_type'] eq ('Partnership')}selected="selected" {/if}  >Partnership Firm</option>
                <option value="Proprietorship" {if $d['company_type'] eq ('Proprietorship')}selected="selected" {/if}  >Proprietorship</option>
                <option value="Section8" {if $d['company_type'] eq ('Section8')}selected="selected" {/if}  >Section 8 Company</option>
        ...
        <div class="col-md-6">
            <div class="form-group h6"><label for="state"><span class="h6">TDS Deduction(%)</span></label>
               <input type="number" id="tds_deduction" name="tds_deduction" class="form-control" value="{$d['tds_deduction']}">
